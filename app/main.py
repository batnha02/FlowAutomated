...
_BAT_CONTENT = (
    ...
    "\r\n"
    ":: Dang ky HKCU Run key de tu dong chay ngam khi dang nhap Windows\r\n"
    "set \"ADIR=%~dp0\"\r\n"
    "set \"ADIR=%ADIR:~0,-1%\"\r\n"
    ...
    "-Name 'AutoStep Agent' "
    "-Value ($q+$d+'\\venv\\Scripts\\pythonw.exe'+$q+' '+$q+$d+'\\agent_standalone.py'+$q) "
    "-PropertyType String -Force | Out-Null\"\r\n"
    "echo [Auto-start] Da dang ky: agent tu dong chay ngam khi dang nhap Windows.\r\n"
    "\r\n"
    "echo.\r\n"
